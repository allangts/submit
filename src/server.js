...
app.post('/users', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, whatsapp, idea, currentPhase, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, email = _a.email, whatsapp = _a.whatsapp, idea = _a.idea, currentPhase = _a.currentPhase;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
...
app.listen(PORT, '0.0.0.0', function () {
    console.log("HTTP Server Running in ".concat(PORT));
});
